  ...
  return (
    <Sheet onOpenChange={setIsOpen} open={isOpen}>
      ...
      <SheetContent side="left" className="px-4">
        ...
        {user ? (
          <div className="mt-4">
            <h2 className="text-xl mb-4">Member</h2>
            <hr className="my-2" />
            <ul className="flex flex-col gap-2">
              ...
              <li>
                <Link href="/account">Halaman member</Link>
              </li>
              <li>
                <Link href="/account/settings">Pengaturan profil</Link>
              </li>
              <li className="mt-6">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center">
              <Button asChild className="w-full sm:flex-1" variant="outline">
                <Link href="/account">Masuk sebagai member</Link>
              </Button>
